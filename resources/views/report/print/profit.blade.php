   ...
   <div class="container">
   	 <div class="row">
						...
						<thead>
							...
							<tr style="border: none !important;">
								<td colspan="5" style="border: none !important;"><p style="text-align: center;font-weight: bold;">Reporte de Ganancias desde {{ date('j M Y',strtotime($start_date)) }} a {{ date('j M Y',strtotime($end_date)) }}</p></td>
