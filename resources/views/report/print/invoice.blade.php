   	 ...
   	 <div class="row">
   	 			<table class="table table-bordered">
						<thead>
							...
							<tr style="border: none !important;">
								<td colspan="8" style="border: none !important;"><p style="text-align: center;font-weight: bold;">Reporte de Facturas desde {{ date('j M Y',strtotime($start_date)) }} a {{ date('j M Y',strtotime($end_date)) }}</p></td>
