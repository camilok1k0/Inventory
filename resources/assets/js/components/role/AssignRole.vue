							...
							<div class="row">
								<div class="col-md-12">
									<!-- 		<div class="demo-checkbox">
										<div class="col-md-4" v-for="value in menus" v-if="value.name !== 'Configuración' || !value.sub_menu.some(sub => sub.name === 'Cambiar la contraseña')">
									...
									<div class="demo-checkbox" v-for="(value, index) in role.menus" :key="index">
										...
										<!-- sub menu  	 -->
										<div class="col-md-4" v-for="sub in value.sub_menu" v-if="sub.name !== 'Cambiar la contraseña'">
